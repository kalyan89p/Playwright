...
test.only('has title', async ({ page }) => {
    ...
    // await page.fill("//input[@id='name']", "Kalyan");
    // await page.fill("//input[@id='email']", "thekalyanche1@gmail.com");
    // await page.fill("//input[@id='phone']", "5186876454");
    // await page.fill("//textarea[@id='textarea']", "4602 Mallard Drive Melbourne 32932");
   ...
   //wait page.locator("//div[@id='draggable]").dragTo(page.locator("//div[@id='droppable']"))
